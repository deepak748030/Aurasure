...
/**
 * Play Store in-app update prompt for the Rider app. The update downloads and
 * installs right here — the partner never has to leave the app for the Play
          ...
          <View style={styles.heading}>
            ...
            <View style={styles.headingCopy}>
              ...
              <Text variant="body" color={colors.textSecondary} style={styles.message}>
                A new version of Aurasure Rider is ready. Install it right here — you don't need to
                open the Play Store.
              </Text>
            </View>
          </View>
