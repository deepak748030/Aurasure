...
const styles = StyleSheet.create({ container: { flex: 1 }, footer: { borderRadius: 0, borderLeftWidth: 0, borderRightWidth: 0, borderBottomWidth: 0, paddingHorizontal: 4 }, tip: { flexDirection: 'row', alignItems: 'center', gap: 9 } });
