...
export const typography = {
  ...
  micro: { fontSize: 11, lineHeight: 14, weight: 'semibold' as FontWeightKey, letterSpacing: 0.2 },
  overline: { fontSize: 10, lineHeight: 14, weight: 'bold' as FontWeightKey, letterSpacing: 1.1 },
