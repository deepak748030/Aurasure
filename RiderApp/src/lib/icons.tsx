...
export type GlyphName = React.ComponentProps<
...
const registry = {
  ...
  clipboard: ["clipboard-text", "clipboard-text-outline"],
  document: ["file-document", "file-document-outline"],
  closeCircle: ["close-circle", "close-circle-outline"],
  cash: ["cash", "cash-multiple"],
  clockCheck: ["clock-check", "clock-check-outline"],
  map: ["map", "map-outline"],
